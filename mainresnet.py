...
from dataset.custom_transform import Standardize
...
from classification_trainer.trainresnet import train_epoch
from classification_trainer.valiresnet import val_epoch
import numpy as np
...
if __name__ =='__main__':
    ...
    min_value, max_value, mean, std = calculation()
