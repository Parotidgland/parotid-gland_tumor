...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default=r'/home/zyyang/concile/my_all/other/medical/classification_pro',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        help='Directory path of train_data')

    parser.add_argument(
        '--valid_label_path',
        default='valid_file.csv',
        type=str,
        help='Directory path of valid_data')
    ...
    parser.add_argument(
        ...
        help='Depth of resnet (10 | 18 | 34 | 50 | 101)// '
             'Depth of densenet (121 | 169 | 201 | 264)')
